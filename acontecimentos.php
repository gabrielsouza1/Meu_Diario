    ...
    <nav class="navbar navbar-default">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Meu Diario</a>
        </div>
 ...
 <section id="main">
 	<div class="container">
        ...
        <a href="acontecimentos.php" class="list-group-item">Acontecimentos</a>
			  ...
			  <a href="#" class="list-group-item">Minhas fotos</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Acontecimento</h4>
      </div>
      <div class="modal-body">
    <form class="form-horizontal" method="POST" action="DAO/ul_acontecimento.php">
        <div class="form-group">
            <div class="col-sm-10">                
                       <textarea id="acontecimentos" name="acontecimentos" class="form-control" rows="5" placeholder="O que anda acontecendo?"></textarea>
            </div>
        </div>
      </div>
...
<br><br>
<?php
echo "<h2>Acontecimento</h2>";
while ($dados = mysqli_fetch_array($query)) {
?>
  <?=   $dados['acontecimentos'] ?><br><br>
<?php
}
?>
 			</div>
